                    ...
                    <table class="table align-items-center mb-0 table-responsive table-hover">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="align-middle text-center">{{ $cs->code }}</td>
                          <td class="align-middle text-center text-sm">{{ $cs->name }}</td>
                          <td class="align-middle text-center">{{ $cs->address }}</td>
                          <td class="align-middle">{{ $cs->phone_number }}</td>
